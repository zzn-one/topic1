<template>
    <el-dialog title="修改选题任务" center :visible.sync="dialogVisible" width="600px" @close="closeDialog">
        <div class="form_div">
        ...
        <div slot="footer" class="dialog_footer">
            <el-button plain type="primary" class="dialog_footer_btn" @click="publish">修 改</el-button>
...
export default {
    ...
    methods: {
        ...
        //根据id获取task信息
        async getTask(id) {
            const resp = await this.$http.get("/task/" + id)
            if (resp.data.code === 200 && resp.data.data !== null) {
                this.taskForm = resp.data.data
            }
        }
